    ...
    private static class Client {
        ...
        private void unignoreFriend() {
            if (this.loggedInUser.hasIgnoredFriends() == false) {
                System.out.println("You don't have anyone to unignore. Try to ignore some friends first.");
                return;
            }
            ...
            String choiceString = System.console().readLine();
            int choice = Integer.parseInt(choiceString);
            Account ignoredFriend = ignoredFriends[choice];

            this.loggedInUser.unIgnoreFriend(ignoredFriend);

            System.out.println("unignored " + ignoredFriend.getName());
        }
        ...
        private void listIgnoredFriends(){
        	if(this.loggedInUser.hasFriends()){
        		Account[] ignoreFriends = this.loggedInUser.getIgnoredFriends();
        		this.printEnumeratedChoices(ignoreFriends);
        	}else {
        ...
        private boolean action() {
            ...
            System.out.print("[K] List ignored friends |  ");
